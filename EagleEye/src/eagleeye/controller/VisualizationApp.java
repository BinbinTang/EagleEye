...
import eagleeye.view.WorkBenchControllerVisualization;
...
public class VisualizationApp extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(VisualizationApp.class.getResource("../view/WorkBenchRootLayout.fxml"));
    ...
    public void showWorkBench() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(VisualizationApp.class.getResource("../view/WorkBench2.fxml"));
            AnchorPane overviewPage = (AnchorPane) loader.load();
            rootLayout.setCenter(overviewPage);
            overviewPage.setMinHeight(400);
            overviewPage.setMinWidth(800);
            WorkBenchControllerVisualization controller = loader.getController();
