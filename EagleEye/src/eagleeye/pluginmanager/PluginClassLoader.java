...
public class PluginClassLoader extends ClassLoader {
  //directory where the plugin class resides
  File directory;
  String pkg;

  //constructor
  public PluginClassLoader (File dir, String p) {
		directory = dir;
		pkg=p;
	}
  ...
  public Class loadClass (String classname, boolean resolve) throws ClassNotFoundException {
    try {
      ...
      if (c == null) {
        ...
        // package name is included to account for package structure in eagleeye
        c = defineClass(pkg+"."+classname, classbytes, 0, length);
