...
public class AndroidBinaryFileReader extends BinaryFileReader
{
	...
	public boolean read(File file) throws Exception
	{
		...
		if(this.readSignature(file))
		{
			return false;
		}

		this.outputGeneralFileInformation();
		...
		ArrayList<MTDDefinition> mtdDefinitions = MTDCommandLineParser
				.parse(mtdDefinitionString);
	...
	public boolean readSignature(File file) throws Exception
	{
		...
		this.inputStream.readFully(magicSignatureBytes);
