...
import eagleeye.controller.VisualizationApp;
...
public class WorkBenchControllerVisualization implements MapComponentInitializedListener{
	...
	private VisualizationApp mainApp;

	/**
	 * The constructor.
	 */
	public WorkBenchControllerVisualization() {
	}
	...
	public void addGeoView(){
	    ...
	    LocationPane.getChildren().add(mapView);
	}
	...
	public void setMainApp(VisualizationApp mainApp) {
