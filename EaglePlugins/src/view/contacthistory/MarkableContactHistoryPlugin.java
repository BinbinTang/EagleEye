...
import eagleeye.api.plugin.MarkableItems;
import eagleeye.api.plugin.Plugin;


public class MarkableContactHistoryPlugin extends Application implements Plugin{
	private List params;
	private MarkableItems mi;
	public MarkableContactHistoryPlugin(){
	...
	public Object getResult() {
        ...
        Node a = seriesApril.getNode();
        if(a!=null)
        	mi.add(a);
        Node m = seriesApril.getNode();
        if(m!=null)
        	mi.add(m);
