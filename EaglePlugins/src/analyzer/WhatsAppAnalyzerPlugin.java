...
public class WhatsAppAnalyzerPlugin implements Plugin{
	private class WAMessage implements Comparable{
	...
	public void writeResultToFile(){
		String f = outputPath+File.separator+"wechat.time";
		try{
	...
	public int setParameter(List argList) {
		WAroot = (String) argList.get(0);
		WAChatHistoryPath = WAroot+File.separator+"Documents"+File.separator+"ChatStorage.sqlite";
